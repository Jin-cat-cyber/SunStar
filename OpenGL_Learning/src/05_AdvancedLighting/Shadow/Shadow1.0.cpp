...
//
//    // 创建着色器对象
//	Shader simpleDepthShader("res/shader/ShadowShader/shadow_mapping_ver.shader", "res/shader/ShadowShader/shadow_mapping_frag.shader");
...
//
//    // 加载贴图
//	unsigned int woodTexture = loadTexture("res/texture/floor.jpg");
//
