...
int main()
{
    ...
    Shader shaderGeometryPass("res/shader/#Deferred/G-Buffer_ver.shader", "res/shader/#Deferred/G-Buffer_frag.shader");
    Shader shaderLightingPass("res/shader/#Deferred/Deferred_shading_ver.shader", "res/shader/#Deferred/Deferred_shading_frag.shader");
