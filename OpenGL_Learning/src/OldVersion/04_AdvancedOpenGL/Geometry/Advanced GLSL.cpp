...
//    // 创建着色器对象
//
//    Shader shaderRed("res/shader/Advanced_GLSL/redver.shader", "res/shader/Advanced_GLSL/redfrag.shader");
//	Shader shaderGreen("res/shader/Advanced_GLSL/greenver.shader", "res/shader/Advanced_GLSL/greenfrag.shader");
//	Shader shaderBlue("res/shader/Advanced_GLSL/bluever.shader", "res/shader/Advanced_GLSL/bluefrag.shader");
//	Shader shaderYellow("res/shader/Advanced_GLSL/yellowver.shader", "res/shader/Advanced_GLSL/yellowfrag.shader");
//
//    // 立方体顶点信息数据
//    float cubeVertices[] = {
//        // positions         
...
//
//	// 将 uniform block 绑定到绑定点0
//	glUniformBlockBinding(shaderRed.ID, uniformBlockIndexRed, 0);
//	glUniformBlockBinding(shaderGreen.ID, uniformBlockIndexGreen, 0);
//	glUniformBlockBinding(shaderBlue.ID, uniformBlockIndexBlue, 0);
//    glUniformBlockBinding(shaderYellow.ID, uniformBlockIndexYellow, 0);
//
//	// 设置统一缓冲区对象（Uniform Buffer Object, UBO）来存储实际的数据布局
...
//
//    // 存储投影矩阵（目前我们仅执行此操作一次）（注：通过调整视场角（FoV），我们不再使用缩放功能）
