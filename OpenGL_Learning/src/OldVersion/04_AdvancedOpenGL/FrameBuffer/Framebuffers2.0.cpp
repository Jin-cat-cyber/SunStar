...
//        // positions   // texCoords
//        -0.24f,  1.0f,  0.0f, 1.0f,
//        -0.24f,  0.6f,  0.0f, 0.0f,
//         0.24f,  0.6f,  1.0f, 0.0f,
//        -0.24f,  1.0f,  0.0f, 1.0f,
//         0.24f,  0.6f,  1.0f, 0.0f,
//         0.24f,  1.0f,  1.0f, 1.0f
//    };
//
//    // cube VAO
...
//
//        // 第一个渲染通道：镜像纹理。
//        // 绑定到framebuffer并像往常一样绘制颜色纹理
//        // 但与视图相机反转。
//        // 绑定到framebuffer和绘制场景，我们通常会颜色纹理
//        glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);
...
//		camera.Yaw += 180.0f;   // 将相机的偏航角旋转 180 度
//		camera.ProcessMouseMovement(0, 0, false);
//		camera.Yaw -= 180.0f;   // 将其恢复到初始方向
//		camera.ProcessMouseMovement(0, 0, true);
//        glm::mat4 view = camera.GetViewMatrix();
//
//		// 设置投影矩阵
//		glm::mat4 projection = glm::perspective(glm::radians(camera.Fov), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f); // 无法适应窗口大小变化版本
//
...
//        // 现在绘制带有屏幕纹理的镜像四边形。
//        // --------------------------------------------
//        glDisable(GL_DEPTH_TEST); // 禁用深度测试，以确保屏幕空间四边形不会因深度测试而被丢弃。
//
//        screenShader.use();
//        glBindVertexArray(quadVAO);
