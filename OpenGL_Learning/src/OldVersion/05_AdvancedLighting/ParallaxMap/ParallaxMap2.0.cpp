...
//float heightScale = 0.1f; // 视差映射的高度缩放
...
//
//      // 创建着色器对象    
//    Shader shader("res/shader/Advanced_lighting/Parallax/Parallax_ver2.0.shader", "res/shader/Advanced_lighting/Parallax/Parallax_frag2.0.shader");
//
//    // 加载贴图
//    //unsigned int diffuseMap = loadTexture("res/texture/ParallaxMap/bricks2.jpg");
//    //unsigned int normalMap = loadTexture("res/texture/ParallaxMap/bricks2_normal.jpg");
//    //unsigned int heightMap = loadTexture("res/texture/ParallaxMap/bricks2_disp.jpg");
//
//    unsigned int diffuseMap = loadTexture("res/texture/ParallaxMap/wood.png");
//    unsigned int normalMap = loadTexture("res/texture/ParallaxMap/toy_box_normal.png");
//    unsigned int heightMap = loadTexture("res/texture/ParallaxMap/toy_box_disp.png");
//
//    // 着色器配置
//    // --------------------
//    shader.use();
