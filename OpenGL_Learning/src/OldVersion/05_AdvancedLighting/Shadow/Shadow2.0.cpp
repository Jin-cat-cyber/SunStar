...
//
//    // 创建着色器对象    
//    Shader shader("res/shader/ShadowShader/shadow_mapping_ver.shader", "res/shader/ShadowShader/shadow_mapping_frag.shader");
//	Shader simpleDepthShader("res/shader/ShadowShader/map_depth_ver.shader", "res/shader/ShadowShader/map_depth_frag.shader");
//    Shader debugDepthQuad("res/shader/ShadowShader/debug_quad_ver.shader", "res/shader/ShadowShader/debug_quad_frag.shader");
//
//
//    float planeVertices[] = {
...
//
//	//      失真，如果在阴影边界之外的区域显示为黑色（0.0, 0.0, 0.0, 1.0），
//    //      则可能会导致阴影边界出现明显的锯齿状失真。为了避免这种情况，
//    //      可以将纹理环绕方式设置为GL_CLAMP_TO_BORDER，并指定边界颜色为白色（1.0, 1.0, 1.0, 1.0）。
//    //      这样，在阴影边界之外的区域将显示为白色，从而减少失真效果。
//    //  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//    //  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//
//	// 设置纹理环绕方式为GL_CLAMP_TO_BORDER，并指定边界颜色为白色（1.0, 1.0, 1.0, 1.0），以便在阴影边界之外的区域显示为白色（无阴影）
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_BORDER);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_BORDER);
//	float bordeColor[] = { 1.0f, 1.0f, 1.0f, 1.0f };
...
//		lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);  // 正交投影，平行光
//		//lightProjection = glm::perspective(glm::radians(90.0f), (float)SHADOW_WIDTH / (float)SHADOW_HEIGHT, near_plane, far_plane); // 透视投影，点光源
