...
//    Shader sunCoronaShader("res/shader/StarShader/StarList2.0/corona_ver.shader", "res/shader/StarShader/StarList2.0/corona_frag.shader");
...
//        sunCoronaShader.setFloat("coronaRadius", SunScale.x * 1.7f); // 204.0f
//
//        glDrawElements(GL_TRIANGLES, starIndices.size(), GL_UNSIGNED_INT, 0);
//
//
