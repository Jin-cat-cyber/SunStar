...
//
//    // 创建着色器对象
//    Shader modelShader("res/shader/ModelShader/model_ver2.0.shader", "res/shader/ModelShader/model_frag2.0.shader");
//    Shader normalShader("res/shader/GeometryShader/ver.shader", "res/shader/GeometryShader/frag.shader", "res/shader/GeometryShader/geo.shader");
//
//    // 加载模型
