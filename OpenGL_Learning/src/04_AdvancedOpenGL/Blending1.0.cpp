...
//
//    // 创建着色器对象
//    Shader shader("res/shader/TheFourShader/deeptest_ver1.0.shader", "res/shader/TheFourShader/deeptest_frag1.0.shader");
//
//    float cubeVertices[] = {
...
//	unsigned int transparentTexture = loadTexture("res/texture/grass.png");
//
//	// 透明物体位置
