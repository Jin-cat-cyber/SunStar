...
//unsigned int setupFrameBuffers(int eidth, int height);  //  离屏渲染帧缓冲
//
...
//    glTexImage2D(GL_TEXTURE_2D, hdrColorBuffer);
...
//    glFramebufferRenderbuffer(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, hdrColorBuffer);
//}
//
//
