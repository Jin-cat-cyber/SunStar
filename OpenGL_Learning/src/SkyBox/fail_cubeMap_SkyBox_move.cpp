...
//			cos(currentFrame * 0.1f), 
//            sin(currentFrame * 0.1f), 
//            0.0f
//        );
//		skyboxShader.setVec3("sunDirection", sunDir);
//
//		// 日夜循环系统 （-1到1，再映射到0-1）
//		float daNight = (sin(currentFrame * 0.05f) + 1.0f) / 2.0f;
//		skyboxShader.setFloat("daNightCycle", daNight);
//
//        // 天空盒
//        glBindVertexArray(skyboxVAO);
//        glActiveTexture(GL_TEXTURE0);
