...
int main()
{
    ...
    Shader pbrShader("res/shader/#PBR/IBL2.0/pbr_ver3.0.shader", "res/shader/#PBR/IBL2.0/pbr_frag3.0.shader");
    Shader equirectangularToCubemapShader("res/shader/#PBR/IBL2.0/cubemap_ver3.0.shader", "res/shader/#PBR/IBL2.0/cubemap_frag3.0.shader");
    Shader irradianceShader("res/shader/#PBR/IBL2.0/cubemap_ver3.0.shader", "res/shader/#PBR/IBL2.0/irradiance_frag.shader");
   
    Shader backgroundShader("res/shader/#PBR/IBL2.0/background_ver.shader", "res/shader/#PBR/IBL2.0/background_frag.shader");
    
    Shader prefilterShader("res/shader/#PBR/IBL2.0/cubemap_ver3.0.shader","res/shader/#PBR/IBL2.0/prefilter_frag.shader");
    Shader brdfShader("res/shader/#PBR/IBL2.0/BRDF_ver.shader", "res/shader/#PBR/IBL2.0/BRDF_frag.shader");
